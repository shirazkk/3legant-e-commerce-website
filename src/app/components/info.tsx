      ...
      <div className="w-full h-full flex gap-6 justify-center items-center flex-wrap ">
        <div className="w-[450px] h-[200px] bg-gray-200">
          <div className="w-full h-full flex justify-center items-center px-8 flex-col">
            ...
            <div className="mt-4">
              <h3 className="text-center text-xl font-semibold text-customGrayBlue py-2">
                Address
              </h3>
              <p className="text-gray-500 text-center text-lg py-2 font-semibold">
        ...
        <div className="w-[450px] h-[200px] bg-gray-200">
          <div className="w-full h-full flex justify-center items-center px-8 flex-col">
            ...
            <div className="mt-4">
              <h3 className="text-center text-xl font-semibold py-2 text-customGrayBlue">
                Phone
              </h3>
              <p className="text-gray-500 text-center text-lg py-2 font-semibold">
                +84 234 567 890
