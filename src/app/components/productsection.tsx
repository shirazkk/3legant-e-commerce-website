          ...
          <div className="overflow-hidden">
            ...
            <div className="relative bg-[url('/assists/homepage/products/gray-sofa.png')]  bg-cover bg-center  w-full h-[80%] ">
              <div className="flex gap-3 absolute flex-col top-6 left-6">
                <div className=" bg-white text-black px-5 py-1 font-semibold text-lg rounded-md">
                  New
                </div>
                <div className=" bg-green-500 text-white px-5 py-1 font-semibold text-lg rounded-md">
                  -50%
                </div>
              </div>
            ...
            <div className="my-2">
              ...
              <p className="font-semibold">
                $199.00{" "}
                <del className="px-3 font-semibold text-gray-500">$400.00</del>{" "}
              </p>
            </div>
          </div>
          <div className="overflow-hidden">
